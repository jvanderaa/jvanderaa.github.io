...
async function copyCodeToClipboard(button, highlightDiv) {
  ...
  try {
    // Direct call to Clipboard API. Safari supports this on user gesture.
    // We skip permissions.query because Safari doesn't support 'clipboard-write' in permissions API.
